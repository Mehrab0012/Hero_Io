...
const Navbar = () => {
    ...
    return (
        <div className='m-auto max-w-[1440px] max-2xl:px-4 max-sm:px-2 py-5 flex flex-row justify-between items-center relative'>
            <Link to="/">
            ...
            {isMenuOpen && (
                <div className='absolute top-16 left-0 w-full bg-white shadow-lg md:hidden'>
                    <ul className='flex flex-col items-center gap-5 py-5'>
                        <Link to='/' className='text-[1rem] text-black font-medium hover:bg-gradient-to-br from-[#632EE3] to-[#9F62F2] bg-clip-text hover:text-transparent cursor-pointer' onClick={() => setIsMenuOpen(false)}>Home</Link>
                        <Link to='/apps' className='text-[1rem] text-black font-medium hover:bg-gradient-to-br from-[#632EE3] to-[#9F62F2] bg-clip-text hover:text-transparent cursor-pointer' onClick={() => setIsMenuOpen(false)}>Apps</Link>
                        <Link to='/installation' className='text-[1rem] text-black font-medium hover:bg-gradient-to-br from-[#632EE3] to-[#9F62F2] bg-clip-text hover:text-transparent cursor-pointer' onClick={() => setIsMenuOpen(false)}>Installation</Link>
                    </ul>
